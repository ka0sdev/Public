...
module.exports = {
  ...
  async execute (interaction) {
    ...
    if (options.getSubcommand() === 'create' && Threshold < 3) return interaction.reply({ embeds: [Embed.setColor(`RED`).setDescription(`You cannot set the threshold below 3.`)], ephemeral: true })
